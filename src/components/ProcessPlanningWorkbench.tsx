...
export function ProcessPlanningWorkbench({ state, location, editingEnabled, serverReady, recoveryOpen, mobileReadOnly, onCommand, onNavigate, onRelationBegin, onRelationPreview, onRelationCommit, onRelationCancel }: ProcessPlanningWorkbenchProps) {
