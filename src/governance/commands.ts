...
import type { GovernanceCommand, GovernanceDocumentV1, GovernancePolicyDataV1 } from './types'
import { assertValidDocument, GovernanceValidationError, validatePolicyData } from './validation'
...
export function commandHash(command: GovernanceCommand) { return sha256(canonicalJson(command)) }
