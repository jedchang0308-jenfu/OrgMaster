...
test('OrgMaster release intent requires immutable production data and first-principal refs', () => {
  ...
  const values = { sourceLock, authorization: { ...common, environment: 'production', remainingHumanAction: 0, expiresAt: '2999-01-01T00:00:00.000Z' }, readiness, foundation: common, infra: { ...common, migrationRunnerDigest: orgProfile.artifact.migrationRunnerUri + '@sha256:' + 'd'.repeat(64) }, runtimeConfig: runtime }
