...
async function main() {
  ...
  // Explicit maintenance artifact production is independent of application release policy.
  if (repositorySlug(runGit(args.sourceRoot, ['remote', 'get-url', 'origin']))?.toLowerCase() !== 'jedchang0308-jenfu/orgmaster') fail('PRODUCTION_DATA_SOURCE_REPOSITORY_INVALID')
